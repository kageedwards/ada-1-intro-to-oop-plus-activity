...
def test_high_school_student_summary_with_parking_and_clubs():
    ...
    assert summary == "Ellis is a junior enrolled in 0 classes, is in 1 clubs (including DJ Club) and has parking privileges"
...
def test_high_school_student_summary_without_parking_or_clubs():
    ...
    assert summary == "Ellis is a junior enrolled in 0 classes and doesn't have parking privileges"